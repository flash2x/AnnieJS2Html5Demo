...
home.Home=function(){
    ...
    s.classList.push({name: "annie.Sprite", scene: "spriteDemo",classObj:"spriteDemo.SpriteDemo",title:"容器显示对象",isMake:true});
    ...
    s.classList.push({name: "annie.Timer", scene: "timerDemo",classObj:"timerDemo.TimerDemo",title:"定时器",isMake:true});
    s.classList.push({name: "annie.Tween", scene: "tweenDemo",classObj:"tweenDemo.TweenDemo",title:"Tween",isMake:true});
    s.classList.push({name: "annie.Sound", scene: "soundDemo",classObj:"soundDemo.SoundDemo",title:"声音",isMake:true});
    s.classList.push({name: "annie.Video", scene: "videoDemo",classObj:"videoDemo.VideoDemo",title:"视频",isMake:true});
    s.classList.push({name: "annie.Filters", scene: "filtersDemo",classObj:"filtersDemo.FiltersDemo",title:"滤镜",isMake:true});
    s.classList.push({name: "annie.Point", scene: "pointDemo",classObj:"pointDemo.PointDemo",title:"Point",isMake:true});
    s.classList.push({name: "annie.Rectangle", scene: "rectangleDemo",classObj:"rectangleDemo.RectangleDemo",title:"Rectangle",isMake:true});
    s.classList.push({name: "annie.URLLoader", scene: "urlLoaderDemo",classObj:"urlLoaderDemo.UrlLoaderDemo",title:"资源加载类",isMake:true});
    s.classList.push({name: "annie.Ajax", scene: "ajaxDemo",classObj:"ajaxDemo.AjaxDemo",title:"Ajax",isMake:true});
    s.classList.push({name: "annie.jsonp", scene: "jsonpDemo",classObj:"jsonpDemo.JsonpDemo",title:"jsonp",isMake:true});
    s.classList.push({name: "annie.navigateToURL", scene: "navigateToURLDemo",classObj:"navigateToURLDemo.NavigateToURLDemo",title:"链接跳转",isMake:true});
    s.classList.push({name: "annie.sendToURL", scene: "sendToURLDemo",classObj:"sendToURLDemo.SendToURLDemo",title:"向后台只传不收",isMake:true});
    ...
    s.classList.push({name: "annieUI.ScrollList", scene: "scrollListDemo",classObj:"scrollListDemo.ScrollListDemo",title:"滚动列表组件",isMake:true});
    s.classList.push({name: "annieUI.SlidePage", scene: "slidePageDemo",classObj:"slidePageDemo.SlidePageDemo",title:"翻页组件",isMake:true});
    s.classList.push({name: "annieUI.FlipBook", scene: "flipBookDemo",classObj:"flipBookDemo.FlipBookDemo",title:"电子杂志组件",isMake:true});
    s.classList.push({name: "annieUI.FacePhoto", scene: "facePhotoDemo",classObj:"facePhotoDemo.FacePhotoDemo",title:"头像或图片加载组件",isMake:true});
    s.classList.push({name: "annieUI.DrawingBoard", scene: "drawingBoardDemo",classObj:"drawingBoardDemo.DrawingBoardDemo",title:"画板组件",isMake:true});
    s.classList.push({name: "annieUI.ScratchCard", scene: "scratchCardDemo",classObj:"scratchCardDemo.ScratchCardDemo",title:"刮刮卡组件",isMake:true});
    s.classList.push({name: "annieUI.Scroller", scene: "scrollerDemo",classObj:"scrollerDemo.ScrollerDemo",title:"Scroller管理类",isMake:true});
