...
home.Home=function(){
    ...
    s.classList.push({name: "stage.MultiTouch", scene: "multTouch",classObj:"multTouch.MultTouch",title:"多点手势示例",isMake:true});
    s.classList.push({name: "stage.Sound", scene: "sound",classObj:"sound.Sound",title:"音乐播放示例",isMake:true});
    s.classList.push({name: "annieUI.FacePhoto", scene: "facePhoto",classObj:"facePhoto.FacePhoto",title:"加载头像示例",isMake:true});
    s.classList.push({name: "annieUI.FlipBook", scene: "flipBook",classObj:"flipBook.FlipBook",title:"电子杂志示例",isMake:true});
    s.classList.push({name: "annieUI.DrawingBoard", scene: "drawingBoard",classObj:"drawingBoard.DrawingBoard",title:"画板示例",isMake:true});
    s.classList.push({name: "annieUI.ScratchCard", scene: "scratchCard",classObj:"scratchCard.ScratchCard",title:"刮刮卡示例",isMake:true});
    ...
    s.classList.push({name: "annieUI.SlidePage", scene: "slidePage",classObj:"slidePage.SlidePage",title:"滑动翻页示例",isMake:true});
