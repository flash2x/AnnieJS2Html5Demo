	...
	s.addEventListener(annie.MouseEvent.CLICK,function (e) {
		switch(e.target.name){
			case "jsBtn":
				...
				loader.load("./resource/urlLoaderDemo/test.js");
				break;
			case "jsonBtn":
				loader.responseType="json";
				loader.load("./resource/urlLoaderDemo/test.json");
				break;
			case "cssBtn":
				loader.responseType="css";
				loader.load("./resource/urlLoaderDemo/test.css");
				break;
			case "xmlBtn":
				loader.responseType="text";
				loader.load("./resource/urlLoaderDemo/test.xml");
				break;
			case "textBtn":
				loader.responseType="text";
				loader.load("./resource/urlLoaderDemo/test.txt");
				break;
			case "imageBtn":
				loader.responseType="image";
				loader.load("./resource/urlLoaderDemo/test.png");
				break;
		}
	});
...
A2xExtend(urlLoaderDemo.UrlLoaderDemo,annie.Sprite);
